...
report_sxw.report_sxw('report.nota_almacen','stock.picking','addons/custom_american/custom_stock/report/report_nota_alma.rml',parser=nota_almacen, header=False)
