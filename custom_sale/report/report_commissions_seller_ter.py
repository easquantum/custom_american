...
class comisiones_venta_ter(report_sxw.rml_parse):
    #Variables Globales----------------------------------------------------
    currentId	= 0
    total	= 0

    def __init__(self, cr, uid, name, context):
		super(comisiones_venta_ter, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.commissions_sale_ter','commissions.seller','addons/custom_american/custom_sale/report/report_commissions_seller_ter.rml',parser=comisiones_venta_ter, header=False)
