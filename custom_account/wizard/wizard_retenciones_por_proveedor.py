...
<form string="Retenciones - contabilidad Por Proveedor">
...
dat_fields = {
	'supplierid': {'string':'Proveedor', 'type':'many2one','relation': 'res.partner', 'required':True, 'domain':[('supplier','=',True)], 'size':132 },
...
class retentionbysupplier(wizard.interface):
	...
	states = {
		...
		'report' : {
			'actions' : [],
			'result': {'type': 'print', 'report': 'retenciones_por_proveedor', 'state': 'end'}
		},
	}

retentionbysupplier("retenciones_proveedor")
