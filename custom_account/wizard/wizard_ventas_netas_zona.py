...
<form string="VENTAS NETAS POR ZONA">
...
dat_fields = {
	'zona': {'string':'Zona', 'type':'many2one','relation': 'res.partner.zone',  'size':100 },
	...
	'all': {'string':"Todas las Zonas",'type':'boolean'}
}


class ventas_netas_porzona(wizard.interface):
	...
	states = {
		...
		'report' : {
			'actions' : [],
			'result': {'type': 'print', 'report': 'ventas_netas_zona', 'state': 'end'}
		},
	}

ventas_netas_porzona("ventas_netas_zona")
