...
<form string="Libro de Compras General">
...
class libro_compras_gral(wizard.interface):
	...
	states = {
		...
		'report' : {
			'actions' : [],
			'result': {'type': 'print', 'report': 'libro_compras_gral', 'state': 'end'}
		},
	}

libro_compras_gral("libro_compras_gral")
