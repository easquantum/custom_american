...
#------------------------------------------------------------------------------
#Se sobreescribe este wizard, para eliminar el campo 'descripcion' del formulario del wizard
#este dato no es necesario ya que es sustiuido en por el valor de sacuencia  'account.invoice.in_refund'
#en metodo refund en 'custom_account.py'
...
wiz_refund('account.invoice.custom.refund')
