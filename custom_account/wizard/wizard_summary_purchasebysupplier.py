...
<form string="Compra por Proveedor">
	<separator colspan="2" string="Busqueda de Notas de Debito"/>
	<newline/>
...
class summary_purchase_bysupplier(wizard.interface):
	...
	states = {
		...
		'report' : {
			'actions' : [],
			'result': {'type': 'print', 'report': 'summary_purchasebysupplier', 'state': 'end'}
		},
	}

# Este argumento es el nombre del wizard en account_wizard.xml
summary_purchase_bysupplier("summary_purchase_supplier")
