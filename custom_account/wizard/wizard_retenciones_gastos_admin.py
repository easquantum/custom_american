...
<form string="Retenciones - contabilidad">
...
class retention(wizard.interface):
	...
	states = {
		...
		'report' : {
			'actions' : [],
			'result': {'type': 'print', 'report': 'retenciones_gastos_admin', 'state': 'end'}
		},
	}

retention("retenciones_gastos_adm")
