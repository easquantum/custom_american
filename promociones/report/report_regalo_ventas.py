...
class promo(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            ...
            'get_total_cant': self._get_total_cant,
        })
    ...
    def _get_total_cant(self,promo):
        cant = 0
        sql = """
...
report_sxw.report_sxw('report.sale_regalo','sale.promocion','addons/custom_american/promociones/report/report_regalo_ventas.rml',parser=promo, header=False)